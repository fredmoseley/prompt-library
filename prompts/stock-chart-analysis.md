...
Add anything you have learned from using this prompt.

- What worked well:
- What did not work:
  - Chart annotation.  Draws rectangles instead of chart patterns.
- Best model or setup:
- Extra instructions:

### TODO

- Alter prompt so it returns option trades.
